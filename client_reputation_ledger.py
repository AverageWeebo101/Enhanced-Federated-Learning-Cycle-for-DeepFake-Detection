...
if __name__ == "__main__":
    ...
    print(
        f"Config: θ={cfg.theta}, γ={cfg.gamma}, decay={cfg.decay_rate}, "
    ...
    for rnd in range(1, NUM_ROUNDS + 1):
        ...
        participants = list(
            np.random.choice(client_ids, size=num_selected, replace=False)
        )
